...
namespace _21_11_tasks
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //task8
            string[] names = { "Faten", "Lama", "Bana", "Lujain","Salma"};
            Console.WriteLine(names[0] +"  "+ names[0].Length);
            Console.WriteLine(names[1] + "  " + names[1].Length);
            Console.WriteLine(names[2] + "  " + names[2].Length);
            Console.WriteLine(names[3] + "  " + names[3].Length);
            Console.WriteLine(names[4] + "  " + names[4].Length);
